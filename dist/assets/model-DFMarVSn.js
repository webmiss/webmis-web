import{d as o,c as t,H as s,o as r}from"./vendor-BCPY0tYI.js";const a={class:"markdown-body"},l={},m="",g=o({__name:"model",setup(c,{expose:n}){return n({frontmatter:{},excerpt:void 0}),(p,e)=>(r(),t("div",a,e[0]||(e[0]=[s(`<h3>创建模型</h3><p><strong>model/Demo.php</strong></p><pre><code class="language-php">&lt;?php
namespace Model;

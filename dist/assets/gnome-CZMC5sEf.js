import{d as a,c as s,H as t,o}from"./vendor-BCPY0tYI.js";const c={class:"markdown-body"},r={},m="",h=a({__name:"gnome",setup(p,{expose:n}){return n({frontmatter:{},excerpt:void 0}),(l,e)=>(o(),s("div",c,e[0]||(e[0]=[t(`<h1>GNOME3桌面</h1><h2>连接网络</h2><pre><code class="language-bash">systemctl start dhcpcd

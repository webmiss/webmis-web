import{d as t,c as s,a,o as r}from"./index-CLvANlI9.js";const o={class:"markdown-body"},u={},i="",d=t({__name:"vpn",setup(p,{expose:n}){return n({frontmatter:{},excerpt:void 0}),(c,e)=>(r(),s("div",o,e[0]||(e[0]=[a(`<h1>VPN 服务器</h1><h2>安装软件</h2><pre><code class="language-bash"># CentOS
dnf update -y

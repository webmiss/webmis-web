import{d as t,c as a,H as s,o}from"./vendor-oTex03eR.js";const l={class:"markdown-body"},c={},i="",u=t({__name:"mariadb",setup(r,{expose:n}){return n({frontmatter:{},excerpt:void 0}),(d,e)=>(o(),a("div",l,e[0]||(e[0]=[s(`<h2>优化( mysql -uroot -p )</h2><pre><code class="language-bash"># 开启表InnoDB: 1开启、0关闭
...
</code></pre><h3>1) MySQL全量备份</h3><pre><code class="language-bash">#!/bin/bash
# 配置
uname=root
passwd=***
dbname=***
...
# 获日志文件
name=$(ls -1t &quot;$path&quot;mysql-bin.* | grep -v &#39;index$&#39; | awk &#39;NR==2&#39; | awk -F&#39;/&#39; &#39;{print $NF}&#39;)
# 备份文件
cp $path$name $file
# 异地备份
...
</code></pre><h3>8) 数据文件备份脚本</h3><pre><code class="language-bash">#!/bin/bash

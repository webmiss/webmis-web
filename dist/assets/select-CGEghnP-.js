import{d as n,c as o,a,o as s}from"./index-CG-Hq01z.js";const d={class:"markdown-body"},p={},g="",i=n({__name:"select",setup(r,{expose:t}){return t({frontmatter:{},excerpt:void 0}),(c,e)=>(s(),o("div",d,e[0]||(e[0]=[a(`<h3>查询</h3><pre><code class="language-php">static function Index() {
  // 查询
  $model = new Demo();

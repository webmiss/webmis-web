import{d as n,c as t,a as r,o as s}from"./index-BqigGUh4.js";const a={class:"markdown-body"},m={},p="",g=n({__name:"model",setup(c,{expose:o}){return o({frontmatter:{},excerpt:void 0}),(d,e)=>(s(),t("div",a,e[0]||(e[0]=[r(`<h3>创建模型</h3><p><strong>model/demo.go</strong></p><pre><code class="language-go">package model

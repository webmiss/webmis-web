import{d as r,c as n,a as t,o}from"./index-AbO7opoS.js";const p={class:"markdown-body"},g={},l="",i=r({__name:"redis",setup(a,{expose:s}){return s({frontmatter:{},excerpt:void 0}),(d,e)=>(o(),n("div",p,e[0]||(e[0]=[t(`<h2>Redis 使用</h2><pre><code class="language-python">from library.redis import Redis
# 对象
redis = Redis()
# 关闭
redis.Close()

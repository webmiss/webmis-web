import{d as r,c as t,a as i,o as n}from"./index-BtLdrSTu.js";const o={class:"markdown-body"},h={},c="",d=r({__name:"build",setup(s,{expose:a}){return a({frontmatter:{},excerpt:void 0}),(l,e)=>(n(),t("div",o,e[0]||(e[0]=[i(`<h2>一、打包</h2><h4>Bash命令</h4><pre><code class="language-bash">./bash build

import{d as o,c as r,H as s,o as a}from"./vendor-oTex03eR.js";const c={class:"markdown-body"},l={},g="",h=o({__name:"docker",setup(t,{expose:n}){return n({frontmatter:{},excerpt:void 0}),(d,e)=>(a(),r("div",c,e[0]||(e[0]=[s(`<h2>Docker容器</h2><p>是一个开源的应用容器引擎，让开发者可以打包他们的应用以及依赖包到一个可移植的容器中，然后发布到任何流行的<code class="">Linux</code>机器上，也可以实现虚拟化。容器是完全使用沙箱机制，相互之间不会有任何接口。</p><h3>1.1 安装</h3><pre><code class="language-bash"># CentOS
yum install docker
# 开机启动

import{d as o,c as r,H as n,o as a}from"./vendor-BCPY0tYI.js";const l={class:"markdown-body"},c={},p="",h=o({__name:"install",setup(s,{expose:t}){return t({frontmatter:{},excerpt:void 0}),(i,e)=>(a(),r("div",l,e[0]||(e[0]=[n(`<h1>Flutter开发环境</h1><h2>ArchLinux</h2><h4>1) 安装Git</h4><pre><code class="language-bash">pacman -S git

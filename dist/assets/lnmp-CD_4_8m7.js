import{d as s,c as a,a as p,o as t}from"./index-C8nBvhCm.js";const o={class:"markdown-body"},c={},h="",d=s({__name:"lnmp",setup(l,{expose:n}){return n({frontmatter:{},excerpt:void 0}),(r,e)=>(t(),a("div",o,e[0]||(e[0]=[p(`<h1>LNMP 环境搭建</h1><h2>Nginx</h2><h4>1) 安装</h4><pre><code class="language-bash">apt install nginx -y
apt autoremove -y
# 查看

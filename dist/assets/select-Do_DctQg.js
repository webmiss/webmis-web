import{d as n,c as t,a,o as d}from"./index-DZw22l5y.js";const s={class:"markdown-body"},p={},m="",h=n({__name:"select",setup(r,{expose:o}){return o({frontmatter:{},excerpt:void 0}),(c,e)=>(d(),t("div",s,e[0]||(e[0]=[a(`<h3>查询</h3><pre><code class="language-python">  # 首页
  def index(self):
    # 查询
    model = Demo()

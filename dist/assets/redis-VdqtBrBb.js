import{d as r,c as n,a as t,o as p}from"./index-CBd8jn0T.js";const g={class:"markdown-body"},c={},i="",l=r({__name:"redis",setup(o,{expose:s}){return s({frontmatter:{},excerpt:void 0}),(a,e)=>(p(),n("div",g,e[0]||(e[0]=[t(`<h2>Redis 使用</h2><pre><code class="language-php">use Library\\Redis;
// 对象
$redis = new Redis();
// 关闭
$redis-&gt;Close();

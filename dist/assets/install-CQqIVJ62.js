import{d as o,c as a,a as r,o as t}from"./index-C8nBvhCm.js";const s={class:"markdown-body"},l={},h="",p=o({__name:"install",setup(c,{expose:n}){return n({frontmatter:{},excerpt:void 0}),(d,e)=>(t(),a("div",s,e[0]||(e[0]=[r(`<h1>ArchLinux系统安装</h1><h2>EFI模式</h2><pre><code class="language-bash">1) 电脑启动模式设置成“UEFI Mode”

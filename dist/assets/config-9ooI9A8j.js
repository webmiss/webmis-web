import{d as a,c as l,a as n,o}from"./index-5_hhwz4s.js";const t={class:"markdown-body"},r={},u="",d=a({__name:"config",setup(c,{expose:s}){return s({frontmatter:{},excerpt:void 0}),(p,e)=>(o(),l("div",t,e[0]||(e[0]=[n(`<h2>开启远程登录</h2><pre><code class="language-bash"> vi /etc/ssh/sshd_config

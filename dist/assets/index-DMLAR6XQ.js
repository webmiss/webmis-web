import{d as i,c as n,a as p,o as s}from"./index-YZy2HEBW.js";const a={class:"markdown-body"},b={},c="",l=i({__name:"index",setup(o,{expose:t}){return t({frontmatter:{},excerpt:void 0}),(r,e)=>(s(),n("div",a,e[0]||(e[0]=[p(`<h1>WebMIS-前端基础框架</h1><p>采用 Vite + Vue3 + TypeScript 开发，包括Web(网站)、VueApp(H5+混合型APP)、Api(接口调试工具)、Admin(后台管理)，运用模块化开发思路，封装基础UI组件</p><ul><li>Web(文档)：<a href="https://webmis.vip">https://webmis.vip</a></li><li>App(H5+混合型APP)：<a href="https://app.webmis.vip">https://app.webmis.vip</a></li><li>Admin(后台管理)：<a href="https://admin.webmis.vip">https://admin.webmis.vip</a></li></ul><br><h2>一、下载</h2><pre><code class="language-bash"># 克隆仓库

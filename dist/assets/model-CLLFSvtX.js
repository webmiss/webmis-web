import{d as n,c as t,H as s,o as r}from"./vendor-BCPY0tYI.js";const l={class:"markdown-body"},p={},m="",g=n({__name:"model",setup(a,{expose:o}){return o({frontmatter:{},excerpt:void 0}),(d,e)=>(r(),t("div",l,e[0]||(e[0]=[s(`<h3>创建模型</h3><p><strong>model/demo.py</strong></p><pre><code class="language-python">from model.model import Model

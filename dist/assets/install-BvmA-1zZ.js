import{d as o,c as a,a as r,o as t}from"./index-CLvANlI9.js";const s={class:"markdown-body"},p={},h="",d=o({__name:"install",setup(c,{expose:n}){return n({frontmatter:{},excerpt:void 0}),(i,e)=>(t(),a("div",s,e[0]||(e[0]=[r(`<h1>ArchLinux系统安装</h1><h2>USB启动盘</h2><pre><code class="language-bash"># 制作U盘启动盘(win下直接拷贝ISO里的文件）

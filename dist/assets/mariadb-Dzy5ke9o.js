import{d as t,c as a,a as s,o as l}from"./index-BtLdrSTu.js";const r={class:"markdown-body"},c={},p="",T=t({__name:"mariadb",setup(o,{expose:e}){return e({frontmatter:{},excerpt:void 0}),(E,n)=>(l(),a("div",r,n[0]||(n[0]=[s(`<h2>优化( mysql -uroot -p )</h2><pre><code class="language-bash"># 开启表InnoDB: 1开启、0关闭
...
</code></pre>`,47)])))}});export{T as default,p as excerpt,c as frontmatter};

import{d as t,c as s,a,o as n}from"./index-CBd8jn0T.js";const c={class:"markdown-body"},l={},g="",d=t({__name:"github",setup(r,{expose:o}){return o({frontmatter:{},excerpt:void 0}),(i,e)=>(n(),s("div",c,e[0]||(e[0]=[a(`<h1>Github-SSH方式</h1><h2>用户名、邮箱</h2><pre><code class="language-bash">git config --global user.name &quot;webmis&quot;

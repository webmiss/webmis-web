import{d as p,c as a,a as s,o as l}from"./index-C8nBvhCm.js";const i={class:"markdown-body"},o={},r="",m=p({__name:"lnmp",setup(t,{expose:n}){return n({frontmatter:{},excerpt:void 0}),(c,e)=>(l(),a("div",i,e[0]||(e[0]=[s(`<h1>LNMP 环境搭建</h1><h2>Nginx</h2><h4>1) 安装</h4><pre><code class="language-bash">dnf install nginx -y
# 开机启动
...
</code></pre><ul><li>user = nginx</li><li>group = nginx</li><li>listen = /run/php-fpm/www.sock</li><li>listen = /var/opt/remi/php83/run/php-fpm/www.sock</li></ul><h4>进程数</h4><ul><li>pm = static</li><li>pm.max_children = 256</li></ul><h4>Opcache</h4><pre><code class="language-bash">/etc/php.d/10-opcache.ini
...
</code></pre><p><br><br></p>`,58)])))}});export{m as default,r as excerpt,o as frontmatter};

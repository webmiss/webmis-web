import{d as t,c as n,a,o as d}from"./index-B-lAKudI.js";const c={class:"markdown-body"},l={},p="",m=t({__name:"select",setup(s,{expose:o}){return o({frontmatter:{},excerpt:void 0}),(r,e)=>(d(),n("div",c,e[0]||(e[0]=[a(`<h3>查询</h3><pre><code class="language-go">func Index(c *gin.Context) {
	// 查询

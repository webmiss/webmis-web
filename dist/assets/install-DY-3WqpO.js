import{d as s,c as r,a,o}from"./index-BVEmXpJm.js";const l={class:"markdown-body"},h={},c="",d=s({__name:"install",setup(t,{expose:p}){return p({frontmatter:{},excerpt:void 0}),(i,e)=>(o(),r("div",l,e[0]||(e[0]=[a(`<h1>Phalcon开发环境</h1><h2>ArchLinux</h2><h4>1) 安装Git</h4><pre><code class="language-bash">pacman -S git

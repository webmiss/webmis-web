import{d as o,c as i,H as n,o as s}from"./vendor-oTex03eR.js";const g={class:"markdown-body"},c={},d="",m=o({__name:"git",setup(a,{expose:e}){return e({frontmatter:{},excerpt:void 0}),(h,t)=>(s(),i("div",g,t[0]||(t[0]=[n(`<h1>Git 服务器搭建</h1><h2>一、服务器配置</h2><h4>1) 创建账号</h4><pre><code class="language-bash">groupadd git
useradd git -g git
passwd git
...
</code></pre><h4>2) RSA密钥( 可选 )</h4><pre><code class="language-bash"># 本地-生成密钥
ssh-keygen -t rsa
# 本地-上传公钥

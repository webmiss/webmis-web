import{d as n,c as t,a as s,o as r}from"./index-B-lAKudI.js";const a={class:"markdown-body"},p={},m="",g=n({__name:"model",setup(l,{expose:o}){return o({frontmatter:{},excerpt:void 0}),(d,e)=>(r(),t("div",a,e[0]||(e[0]=[s(`<h3>创建模型</h3><p><strong>model/demo.py</strong></p><pre><code class="language-python">from model.model import Model

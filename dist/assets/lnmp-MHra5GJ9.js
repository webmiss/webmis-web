import{d as a,c as t,a as s,o}from"./index-B-lAKudI.js";const p={class:"markdown-body"},c={},h="",d=a({__name:"lnmp",setup(i,{expose:n}){return n({frontmatter:{},excerpt:void 0}),(l,e)=>(o(),t("div",p,e[0]||(e[0]=[s(`<h1>LNMP 环境搭建</h1><h2>Nginx</h2><h4>1) 安装</h4><pre><code class="language-bash">apt install nginx -y
apt autoremove -y
# 查看

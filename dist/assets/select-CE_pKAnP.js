import{d as n,c as t,H as d,o as a}from"./vendor-BCPY0tYI.js";const s={class:"markdown-body"},p={},m="",h=n({__name:"select",setup(r,{expose:o}){return o({frontmatter:{},excerpt:void 0}),(c,e)=>(a(),t("div",s,e[0]||(e[0]=[d(`<h3>查询</h3><pre><code class="language-python">  # 首页
  def index(self):
    # 查询
    model = Demo()

import{d as p,c as a,a as s,o as l}from"./index-CBd8jn0T.js";const i={class:"markdown-body"},h={},r="",d=p({__name:"lnmp",setup(o,{expose:n}){return n({frontmatter:{},excerpt:void 0}),(t,e)=>(l(),a("div",i,e[0]||(e[0]=[s(`<h1>LNMP 环境搭建</h1><h2>Nginx</h2><h4>1) 安装</h4><pre><code class="language-bash"># 选择版本

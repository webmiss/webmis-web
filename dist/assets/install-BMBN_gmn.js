import{d as n,c as s,a as o,o as a}from"./index-Dldsk6pd.js";const l={class:"markdown-body"},d={},p="",g=n({__name:"install",setup(t,{expose:r}){return r({frontmatter:{},excerpt:void 0}),(i,e)=>(a(),s("div",l,e[0]||(e[0]=[o(`<h1>Vue开发环境</h1><h2>ArchLinux</h2><h4>1) 安装Git</h4><pre><code class="language-bash">pacman -S git
